...
from tests.utils.services import update_wallet_setting_url

#
# def update_wallet_setting(currency_id, setting_name, setting_value, auth_token):
#     payload = {
...
#     response = post(update_wallet_setting_url, payload, headers=headers)
#
